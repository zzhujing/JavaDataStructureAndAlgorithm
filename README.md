## 个人的Java数据结构和Java并发学习项目

### Java并发相关文章/源码链接

- [thread基础相关](md/thread.md)
- [死锁Demo](src/main/java/com/concurrent/thread/deadlock/DeadLockTest.java)
- [Synchronize关键字](src/main/java/com/concurrent/thread/synchronize/SynchronizedLockWithStatic.java)
- [线程间通信以及简单的生产者消费者模型](src/main/java/com/concurrent/thread/communicate/ThreadCommunicateOneToOne.java)
- [wait和Sleep方法的区别](src/main/java/com/concurrent/thread/communicate/DifferenceOfWaitAndSleep.java)
- [生产者消费者简单实战](src/main/java/com/concurrent/thread/communicate/CaptureService.java)
- [自定义显示lock](src/main/java/com/concurrent/thread/lock/BooleanLock.java)
- [自定义简易线程池](src/main/java/com/concurrent/thread/threadpool/SimpleThreadPool.java)
- [五种单例实现方式](src/main/java/com/concurrent/design/singleton)
